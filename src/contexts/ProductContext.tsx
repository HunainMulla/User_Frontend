...
export interface Product {
  ...
  name: string;
  description: string;
  price?: string; // legacy single-size price
  originalPrice: string;
  category: string;
  size?: string; // legacy single-size volume
  sizes?: { volume: string; price: string }[]; // multiple size-price options
  inStock: boolean;
  image: string;
  notes: string[];
  rating?: number;
...
const initialProducts: Product[] = [
  {
    ...
    originalPrice: "$150",
    sizes: [
      { volume: "50ml", price: "$120" },
      { volume: "20ml", price: "$45" }
    ],
  ...
  },
  {
    ...
    originalPrice: "$180",
    sizes: [
      { volume: "50ml", price: "$150" },
      { volume: "20ml", price: "$50" }
    ],
  ...
  },
  {
    ...
    originalPrice: "$220",
    sizes: [
      { volume: "50ml", price: "$180" },
      { volume: "20ml", price: "$60" }
    ],
  ...
  },
  {
    ...
    originalPrice: "$190",
    sizes: [
      { volume: "50ml", price: "$165" },
      { volume: "20ml", price: "$55" }
    ],
